...
public class FragmentDos extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        personasList.add( new Personas("Rocio","Poma","https://ibb.co/7nV2VPJ","7544619"));
        personasList.add( new Personas("Carlos","Sanchez","https://i.ibb.co/fSrw6B4/image.png","7844619"));
        personasList.add( new Personas("Estefanny","Peralta","","6544610") );
        personasList.add( new Personas("Roberto","Sustach","","68906542"));
        personasList.add( new Personas("Flor","Rivera","","6289901"));

        //ArrayAdapter<Personas> adapter=new ArrayAdapter<>(getContext(), android.R.layout.simple_list_item_multiple_choice,personasList);

        PersonasAdapter adapter=new PersonasAdapter(getContext(),personasList);
